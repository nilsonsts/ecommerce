<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="slider-area">
    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            <li>
                <img src="/res/site/img/Hemograma.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        Hematologia <span class="primary">Analisa<strong>Vet</strong></span>
                    </h2>
                    <h4 class="caption subtitle">Consulte Exames</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Consultar</a>
                </div>
            </li>
            <li><img src="/res/site/img/bioquimica.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        Bioquimica <span class="primary">Analisa<strong>Vet</strong></span>
                    </h2>
                    <h4 class="caption subtitle">Consulte Exames</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Consultar</a>
                </div>
            ...
            <!--<li><img src="/res/site/img/h4-slide3.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        Sorologia <span class="primary">Store <strong>Ipod</strong></span>
                    </h2>
            ...
            <li><img src="/res/site/img/h4-slide4.png" alt="Slide">
                <div class="caption-group">
                  <h2 class="caption title">
                        Urinálise <span class="primary">Store <strong>Ipod</strong></span>
                    </h2>
            ...
            <li><img src="/res/site/img/h4-slide4.png" alt="Slide">
                <div class="caption-group">
                  <h2 class="caption title">
                        PCR <span class="primary">Store <strong>Ipod</strong></span>
                    </h2>
                    <h4 class="caption subtitle">& Phone</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                </div>
